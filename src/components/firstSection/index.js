    ...
    <div>
      <Container>
            <ImgProfile src={Perfil} alt="img-profile" />
                ...
                <IconsContainer>
                <a href="https://github.com/wendellima94" rel="noreferrer" target="_blank">
                    <img src={GitIcon} alt="git-icon"  /></a>
                <a href="https://www.linkedin.com/in/wendel-de-lima-74b6b01a1/" rel="noreferrer" target="_blank">
